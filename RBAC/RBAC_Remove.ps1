...
$Resource = "deviceManagement/roleDefinitions"
    ...
    try {
        ...
        (Invoke-IntuneRestMethod -Uri $uri -Method GET).Value | Where-Object { ($_.'displayName').contains("$Name") -and $_.isBuiltInRoleDefinition -eq $false }
...
$Resource = "deviceManagement/roleDefinitions/$roleDefinitionId"
    ...
    try {
        ...
        if("" -eq $roleDefinitionId -or $null -eq $roleDefinitionId){
