...
$Resource = "deviceAppManagement/mobileApps"
    ...
    try {
        ...
        (Invoke-IntuneRestMethod -Uri $uri -Method GET).Value | ? { ($_.'@odata.type').Contains("managedAndroidStoreApp") }
        ...
        $uri = "$global:GraphEndpoint/$graphApiVersion/$($Resource)"
        (Invoke-IntuneRestMethod -Uri $uri -Method GET).Value | ? { ($_.'@odata.type').Contains("managedIOSStoreApp") }
        ...
        $uri = "$global:GraphEndpoint/$graphApiVersion/$($Resource)"
        (Invoke-IntuneRestMethod -Uri $uri -Method GET).Value | ? { ($_.'@odata.type').Contains("managed") }
