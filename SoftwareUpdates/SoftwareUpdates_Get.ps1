...
.EXAMPLE
Get-SoftwareUpdatePolicy -Windows
...
$graphApiVersion = "Beta"
    ...
    try {
        ...
        write-host "Multiple parameters set, specify a single parameter -iOS or -Windows against the function" -f Red

        }

        elseif($Count_Params -eq 0){

        Write-Host "Parameter -iOS or -Windows required against the function..." -ForegroundColor Red
        Write-Host
        break
...
$WSUPs = Get-SoftwareUpdatePolicy -Windows
